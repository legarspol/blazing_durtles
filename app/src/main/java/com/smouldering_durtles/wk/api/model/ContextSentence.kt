 ...
 * their context sentences as a JSON blob in a Room column (see
 ...
 */
@Serializable
data class ContextSentence @JsonCreator constructor(
    @param:JsonProperty("en") @SerialName("en") val english: String? = null,
    @param:JsonProperty("ja") @SerialName("ja") val japanese: String? = null
)
